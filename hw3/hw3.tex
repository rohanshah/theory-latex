...
proof by induction\newline
case: $i = 0$
\newline $p \equiv_{0} q \text{ iff } p,q \in F \text{ or } p,q \notin F $ therefore $p \equiv q$ \newline
inductive step:\newline inductive hypothesis: if $p \equiv q$ then $p \equiv_i q$\newline
if $p \equiv q \text{ then } p \equiv_i q \text{ then } \delta(p,a) = \delta(q,a) \text { and by the inductive hypothesis } \delta(p,a) \equiv_i \delta(q,a) \text{ therefore } p \equiv_{i+1} q$
